...
export const MOCK_SONGS: Song[] = [
  ...
  },
  {
    ...
    plays: 2800000,
    lyrics: [
      { timestamp: 0, text: 'Every shame I carried in my name was laid' },
      { timestamp: 3500, text: 'Every curse I bore was nailed there instead' },
      { timestamp: 7000, text: 'I\'ve been given beauty for these ashes' },
      { timestamp: 10500, text: 'A royal robe for this old sackcloth' },
      { timestamp: 14000, text: 'And I\'m learning who You are' },
      { timestamp: 17500, text: 'What a beautiful Name' },
      { timestamp: 21000, text: 'Powerful Name' },
      { timestamp: 24500, text: 'The Name of Jesus Christ my King' },
      { timestamp: 28000, text: 'Every weapon formed against me breaks' },
      { timestamp: 31500, text: 'Every sickness lost its power' },
      { timestamp: 35000, text: 'When I speak Your Name, all of hell trembles' },
      { timestamp: 38500, text: 'You\'re my breakthrough and my shield' },
      { timestamp: 42000, text: 'And I\'m learning to praise' },
      { timestamp: 45500, text: 'What a beautiful Name' },
      { timestamp: 49000, text: 'Powerful Name' },
      { timestamp: 52500, text: 'The Name of Jesus Christ my King' },
    ],
  },
];
